...
Problem: Given a positive number 'N', find all combinations of '2xN' elements such that every element from 1 to N appears 
exactly twice and the distance between its two appearances is exactly equal to the value of the element.
